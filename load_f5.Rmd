...
exprs.mat = as.matrix(data.tab[3:nrow(data.tab),7:ncol(data.tab)]) # skip statistics and annotation
...
```{r}
fdata.tab = data.tab[3:nrow(data.tab),1:6] # skip statistics
fdata.annotated = new("AnnotatedDataFrame", data=fdata.tab)
```
